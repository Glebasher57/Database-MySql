...
-- наверное можно было бы внести эти данные в таблицу профилей,
-- но на самом сайте WildBerries.ru выходит отдельная форма при по нажатии на кнопку изменения параметров
-- предполагаю что они потом подтягиваются в профиль из отдельной таблицы
-- может я и не прав
